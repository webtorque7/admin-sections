<?php
/**
 * Handler for {@link SiteTree} history in {@link AdminSectionsMain}
 * @todo Add extra security
 */
class AdminSectionsHistoryController extends AdminSectionsMain {

	static $url_segment = 'admin-sections/history';
	static $url_rule = '$URLSegment/$Action/$ID/$VersionID/$OtherVersionID';
	static $url_priority = 51;
	...
	public static $url_handlers = array(
		'$URLSegment/$Action/$ID/$VersionID/$OtherVersionID' => 'handleAction'
	);
